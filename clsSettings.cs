    ...
    { 
        ...
        using (XmlReader xReader = XmlReader.Create(sName, settings)) { 
            { 
                ...
                Machine.Spheroidus = xReader.ReadElementContentAsString();
                Machine.Extrusion = xReader.ReadElementContentAsString();
                Machine.Suction = xReader.ReadElementContentAsString();
                Machine.Linear = xReader.ReadElementContentAsString();
                Machine.RapidDose = xReader.ReadElementContentAsString();
                Machine.Rapid = xReader.ReadElementContentAsString();
                Machine.Dwell = xReader.ReadElementContentAsString();
